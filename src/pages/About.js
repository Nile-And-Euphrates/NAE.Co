        ...
        <>
            ...
            <section class="grid-6 position-relative w-100" style={{ padding:"100px 40px"}}>
                <article class="d-grid" style={{placeItems: "left"}} >
                    ...
                    <p class="text-uppercase p-3 fs-5 mt-4 mb-4" style={{textAlign: "center" , height:"100px" ,whiteSpace:"wrap"}}>في  النيل و الفرات ، نحن نفخر بتقديم حلول راقية للحمامات والسيراميك، مع التركيز على الجودة الفائقة والتصميم المبتكر. منذ تأسيسنا، .</p>
